...
_PIPELINECLASSIFIER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='stringClassLabels', full_name='CoreML.Specification.PipelineClassifier.stringClassLabels', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='int64ClassLabels', full_name='CoreML.Specification.PipelineClassifier.int64ClassLabels', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='ClassLabels', full_name='CoreML.Specification.PipelineClassifier.ClassLabels',
...
_PIPELINECLASSIFIER.fields_by_name['stringClassLabels'].message_type = DataStructures__pb2._STRINGVECTOR
_PIPELINECLASSIFIER.fields_by_name['int64ClassLabels'].message_type = DataStructures__pb2._INT64VECTOR
_PIPELINECLASSIFIER.oneofs_by_name['ClassLabels'].fields.append(
  _PIPELINECLASSIFIER.fields_by_name['stringClassLabels'])
_PIPELINECLASSIFIER.fields_by_name['stringClassLabels'].containing_oneof = _PIPELINECLASSIFIER.oneofs_by_name['ClassLabels']
_PIPELINECLASSIFIER.oneofs_by_name['ClassLabels'].fields.append(
  _PIPELINECLASSIFIER.fields_by_name['int64ClassLabels'])
_PIPELINECLASSIFIER.fields_by_name['int64ClassLabels'].containing_oneof = _PIPELINECLASSIFIER.oneofs_by_name['ClassLabels']
